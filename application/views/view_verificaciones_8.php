...
<head>
	...
	<title>Datos de Verificaci&oacute;n <?php echo $datos_empresa_verificacion[0]['nro_verificacion_emp'];?></title>
...
<tbody>
    <?php 
    if( $datos_empresa_verificacion[0]['nro_verificacion_emp']<>""){
                          ...
                          // if(count($datos_empresa)>1){
                                foreach($datos_empresa_verificacion as $dato){
                                    ...
                                    <th><B>Nombres y Apellidos: </b></th>".$dato['primer_nombre']." ".$dato['segundo_nombre']." ".$dato['primer_apellido']." ".$dato['segundo_apellido']." <BR>
