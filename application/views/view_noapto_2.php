...
<head>
		...
		<title>NO APTOS en <?php echo $sistema; ?></title>
...
$(function () {
    ...
    Highcharts.data({
        ...
        parsed: function (columns) {
            ...
            buttons: {
                customButton: {
                    text: 'No Aptos - Lenel - Nómina',
                    onclick: function () {
                        
                        //javascript:history.back(1);                
                        window.location.href = "<?php echo base_url('noapto');?>";
        //alert('You pressed the button!');
                ...
                title: {
                    text: 'NO APTOS en SIEV encontrados en <?php echo $sistema; ?>'
                },
                subtitle: {
                        ...
                        events: {
                            click: function () {
                                if (this.series != null) {                    
                                    ...
                                    casos_3(this.series.name, this.name,$("#sistema").val());
                                }
                            }
                        }
                    }
...
function casos_3(filial, region, sistema){
        
        //$("#cargando").show();
        $("#tabla").hide();
        
        $.ajax({
        url:"<?php echo base_url('noapto/casos_3');?>",
        type: "POST",
        data:{
        filial:filial,region:region,sistema:sistema
        },
...
<input type="hidden" id="sistema" value="<?php echo $sistema; ?>"/>
        <center>
            <div id="container" style="min-width: 200px; max-width: 1400px; max-height: 1000px; margin: 0 auto"></div>
