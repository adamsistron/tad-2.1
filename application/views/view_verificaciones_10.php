...
$(function () {
    ...
    Highcharts.data({
        ...
        //alert('You pressed the button!');
                ...
                title: {
                    text: 'Verificaciones con estatus <?php echo $estatus; ?> de <?php echo $anio; ?> por Filial '
                },
                subtitle: {
                ...
                plotOptions: {
                    ...
                    point: {
                        events: {
                            click: function () {
                                if (this.series != null) {                    
                                    var org = this.series.name;
                                    var filial = this.name;
                                    var anio = $("#anio").val();
                                    var estatus = $("#estatus").val();
                                    
                                    //alert(this.series.name+'-'+this.name+'-'+$("#anio").val()+'-'+$("#estatus").val());
                                    window.location.href = "<?php echo base_url('verificaciones/verificaciones_2');?>/"+org+'/'+filial+'/'+anio+'/'+estatus;
                                }
                            }
                        }
                    }
